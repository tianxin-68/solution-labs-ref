 ...
 */
@Service
public class DataBaseImportMysql implements DataBaseImportInterface{
    ...
    public List<TableInfo> getAllTable(DataSourceType dataSourceType){
        List<TableInfo> list =  (List<TableInfo>)dao.queryObjectList("entity.dataBaseImport.getAllTableMysql",null,dataSourceType);
        return list;
    }

    @Override
    public List<TableField> getField(Map<String,Object> map, DataSourceType dataSourceType) {
        List<TableField> list = (List<TableField>)dao.queryObjectList("entity.dataBaseImport.getFieldMysql",map,dataSourceType);
        return list;
    }
}
