 ...
 * 保养-关键页曝光平均车龄
 */
public class MaintenanceCarYearDataSourceViewBuilder extends BaseDataSourceViewBuilder {

    private final String analysisBusinessLine;

    public MaintenanceCarYearDataSourceViewBuilder(StarModel model, QueryConfigure config, QueryContext cxt,
