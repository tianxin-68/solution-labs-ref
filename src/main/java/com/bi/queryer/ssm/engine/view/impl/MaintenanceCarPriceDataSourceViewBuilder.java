 ...
 * 保养-关键页曝光平均车价
 */
public class MaintenanceCarPriceDataSourceViewBuilder extends BaseDataSourceViewBuilder {

    private final String analysisBusinessLine;

    public MaintenanceCarPriceDataSourceViewBuilder(StarModel model, QueryConfigure config, QueryContext cxt,
