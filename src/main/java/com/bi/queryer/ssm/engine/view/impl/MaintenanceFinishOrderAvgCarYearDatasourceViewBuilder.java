 ...
 * 保养-履约平均车龄
 */
public class MaintenanceFinishOrderAvgCarYearDatasourceViewBuilder extends BaseDataSourceViewBuilder {

    private final String analysisBusinessLine;

    public MaintenanceFinishOrderAvgCarYearDatasourceViewBuilder(StarModel model, QueryConfigure config, QueryContext cxt,
    ...
    protected List<String> getExtendDims() {
        List<String> extendDims = Arrays.asList("vf.finish_order_user", "vf.dim_tid", "vf.dim_car_year");
        return extendDims;
    }
