 ...
 * 保养-履约平均车价
 */
public class MaintenanceFinishOrderAvgCarPriceDatasourceViewBuilder extends BaseDataSourceViewBuilder {

    private final String analysisBusinessLine;

    public MaintenanceFinishOrderAvgCarPriceDatasourceViewBuilder(StarModel model, QueryConfigure config, QueryContext cxt,
    ...
    protected List<String> getExtendDims() {
        List<String> extendDims = Arrays.asList("vf.finish_order_user", "vf.dim_tid", "vf.tid_guide_price");
        return extendDims;
    }
    ...
    public StringBuilder buildWhereClause() {
        ...
        whereSQL.append(" and vf.finish_order_user is not null ");
        return whereSQL;
    }
}
